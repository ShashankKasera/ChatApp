...
public class ChatsFragment extends Fragment {
            ...
            protected void onBindViewHolder(final ChatHolder holder, int position, final Message model) {
                ...
                query1.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.getChildren().iterator().next().child("type").getValue().toString().equals("image")){

                                    holder.imagelastmessages.setVisibility(View.VISIBLE);
                                    holder.lastChat.setText("image");
    ...
    class ChatHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView imagelastmessages;
        LinearLayout linearLayout;
        public ChatHolder(@NonNull View itemView) {
            super(itemView);

            imagelastmessages = itemView.findViewById(R.id.image_last_message);
